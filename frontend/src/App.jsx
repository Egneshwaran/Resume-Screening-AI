    ...
    return (
        <Routes>
            ...
            <Route path="/admin">
                ...
                <Route path="settings" element={<ProtectedRoute><AdminLayout><div className="p-8 text-center text-slate-400">Settings Page Coming Soon</div></AdminLayout></ProtectedRoute>} />
            </Route>
